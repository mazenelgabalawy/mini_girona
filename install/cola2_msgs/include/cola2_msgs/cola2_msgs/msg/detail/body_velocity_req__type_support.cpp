...
{
  new (message_memory) cola2_msgs::msg::BodyVelocityReq(_init);
}

void BodyVelocityReq_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cola2_msgs::msg::BodyVelocityReq *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BodyVelocityReq_message_member_array[4] = {
  {
    ...
    offsetof(cola2_msgs::msg::BodyVelocityReq, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cola2_msgs::msg::BodyVelocityReq, goal),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cola2_msgs::msg::BodyVelocityReq, twist),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cola2_msgs::msg::BodyVelocityReq, disable_axis),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BodyVelocityReq_message_members = {
  ...
  4,  // number of fields
  sizeof(cola2_msgs::msg::BodyVelocityReq),
...
{
  return &::cola2_msgs::msg::rosidl_typesupport_introspection_cpp::BodyVelocityReq_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cola2_msgs, msg, BodyVelocityReq)() {
  return &::cola2_msgs::msg::rosidl_typesupport_introspection_cpp::BodyVelocityReq_message_type_support_handle;
}
