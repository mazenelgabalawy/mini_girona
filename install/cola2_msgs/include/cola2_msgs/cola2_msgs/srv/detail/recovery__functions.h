...
#ifndef COLA2_MSGS__SRV__DETAIL__RECOVERY__FUNCTIONS_H_
#define COLA2_MSGS__SRV__DETAIL__RECOVERY__FUNCTIONS_H_
...
/// Initialize srv/Recovery message.
/**
...
/// Create srv/Recovery message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cola2_msgs__srv__Recovery_Request__init().
...
/// Destroy srv/Recovery message.
/**
 * It calls
 * cola2_msgs__srv__Recovery_Request__fini()
...
/// Check for srv/Recovery message equality.
/**
...
/// Initialize array of srv/Recovery messages.
/**
...
/// Finalize array of srv/Recovery messages.
/**
 * It calls
 * cola2_msgs__srv__Recovery_Request__fini()
...
/// Create array of srv/Recovery messages.
/**
 * It allocates the memory for the array and calls
 * cola2_msgs__srv__Recovery_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Recovery messages.
/**
 * It calls
 * cola2_msgs__srv__Recovery_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Recovery message array equality.
/**
...
/// Copy an array of srv/Recovery messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cola2_msgs__srv__Recovery_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cola2_msgs
...
/**
 * It calls
 * cola2_msgs__srv__Recovery_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cola2_msgs
...
/**
 * It allocates the memory for the array and calls
 * cola2_msgs__srv__Recovery_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cola2_msgs
...
/**
 * It calls
 * cola2_msgs__srv__Recovery_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COLA2_MSGS__SRV__DETAIL__RECOVERY__FUNCTIONS_H_
