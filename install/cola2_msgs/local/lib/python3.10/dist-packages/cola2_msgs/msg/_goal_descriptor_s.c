...
bool cola2_msgs__msg__goal_descriptor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cola2_msgs.msg._goal_descriptor.GoalDescriptor", full_classname_dest, 46) == 0);
  }
  cola2_msgs__msg__GoalDescriptor * ros_message = _ros_message;
  {  // requester
...
{
  /* NOTE(esteve): Call constructor of GoalDescriptor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cola2_msgs.msg._goal_descriptor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GoalDescriptor");
