...
bool cola2_msgs__msg__recovery_action__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cola2_msgs.msg._recovery_action.RecoveryAction", full_classname_dest, 46) == 0);
  }
  cola2_msgs__msg__RecoveryAction * ros_message = _ros_message;
  {  // header
  ...
  {  // error_level
    ...
    ros_message->error_level = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // error_string
...
{
  /* NOTE(esteve): Call constructor of RecoveryAction */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cola2_msgs.msg._recovery_action");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RecoveryAction");
