...
bool cola2_msgs__msg__key_value__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cola2_msgs.msg._key_value.KeyValue", full_classname_dest, 34) == 0);
  }
  cola2_msgs__msg__KeyValue * ros_message = _ros_message;
  {  // key
...
PyObject * cola2_msgs__msg__key_value__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cola2_msgs.msg._key_value");
