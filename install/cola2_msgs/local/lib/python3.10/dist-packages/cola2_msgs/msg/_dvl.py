...
class Metaclass_DVL(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from cola2_msgs.msg import DVLBeam
...
class DVL(metaclass=Metaclass_DVL):
    ...
    _fields_and_field_types = {
        ...
        'altitude': 'double',
        'beams': 'sequence<cola2_msgs/DVLBeam>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['cola2_msgs', 'msg'], 'DVLBeam')),  # noqa: E501
    )
