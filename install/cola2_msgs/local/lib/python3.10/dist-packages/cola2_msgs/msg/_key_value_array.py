...
class Metaclass_KeyValueArray(type):
    """Metaclass of message 'KeyValueArray'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'cola2_msgs.msg.KeyValueArray')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__key_value_array
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__key_value_array
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__key_value_array
            cls._TYPE_SUPPORT = module.type_support_msg__msg__key_value_array
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__key_value_array
...
class KeyValueArray(metaclass=Metaclass_KeyValueArray):
    """Message class 'KeyValueArray'."""
