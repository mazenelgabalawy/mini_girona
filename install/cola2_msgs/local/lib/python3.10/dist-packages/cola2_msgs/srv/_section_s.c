...
bool cola2_msgs__srv__section__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cola2_msgs.srv._section.Section_Request", full_classname_dest, 39) == 0);
  }
  cola2_msgs__srv__Section_Request * ros_message = _ros_message;
  {  // initial_x
    ...
    ros_message->initial_x = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // initial_y
    ...
    assert(PyFloat_Check(field));
    ros_message->initial_y = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // initial_depth
...
{
  /* NOTE(esteve): Call constructor of Section_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cola2_msgs.srv._section");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Section_Request");
  ...
  {  // initial_x
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->initial_x);
    {
  ...
  {  // initial_y
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->initial_y);
    {
...
ROSIDL_GENERATOR_C_EXPORT
bool cola2_msgs__srv__section__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cola2_msgs.srv._section.Section_Response", full_classname_dest, 40) == 0);
  }
  cola2_msgs__srv__Section_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of Section_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cola2_msgs.srv._section");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Section_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
