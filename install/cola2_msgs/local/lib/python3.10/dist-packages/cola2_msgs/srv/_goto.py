...
class Metaclass_Goto_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'cola2_msgs.srv.Goto_Request')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__goto__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__goto__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__goto__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__goto__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__goto__request
    ...
    def NED(self):
        ...
        return Metaclass_Goto_Request.__constants['NED']

    @property
    def GLOBAL(self):
        """Message constant 'GLOBAL'."""
        return Metaclass_Goto_Request.__constants['GLOBAL']

    @property
    def DEPTH(self):
        """Message constant 'DEPTH'."""
        return Metaclass_Goto_Request.__constants['DEPTH']

    @property
    def ALTITUDE(self):
        """Message constant 'ALTITUDE'."""
        return Metaclass_Goto_Request.__constants['ALTITUDE']

    @property
    def BOTH(self):
        """Message constant 'BOTH'."""
        return Metaclass_Goto_Request.__constants['BOTH']
...
class Metaclass_Goto_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cola2_msgs.srv.Goto_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__goto__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__goto__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__goto__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__goto__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__goto__response
...
class Metaclass_Goto(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._TYPE_SUPPORT = module.type_support_srv__srv__goto

            from cola2_msgs.srv import _goto
            if _goto.Metaclass_Goto_Request._TYPE_SUPPORT is None:
                _goto.Metaclass_Goto_Request.__import_type_support__()
            if _goto.Metaclass_Goto_Response._TYPE_SUPPORT is None:
                _goto.Metaclass_Goto_Response.__import_type_support__()


class Goto(metaclass=Metaclass_Goto):
    from cola2_msgs.srv._goto import Goto_Request as Request
    from cola2_msgs.srv._goto import Goto_Response as Response
