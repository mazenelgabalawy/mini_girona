...
bool stonefish_ros2__msg__dvl_beam__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * stonefish_ros2__msg__dvl_beam__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool stonefish_ros2__msg__dvl__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("stonefish_ros2.msg._dvl.DVL", full_classname_dest, 27) == 0);
  }
  stonefish_ros2__msg__DVL * ros_message = _ros_message;
  {  // header
  ...
  {  // beams
    ...
    if (!stonefish_ros2__msg__DVLBeam__Sequence__init(&(ros_message->beams), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create stonefish_ros2__msg__DVLBeam__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    stonefish_ros2__msg__DVLBeam * dest = ros_message->beams.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!stonefish_ros2__msg__dvl_beam__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * stonefish_ros2__msg__dvl__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("stonefish_ros2.msg._dvl");
  ...
  {  // beams
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = stonefish_ros2__msg__dvl_beam__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
