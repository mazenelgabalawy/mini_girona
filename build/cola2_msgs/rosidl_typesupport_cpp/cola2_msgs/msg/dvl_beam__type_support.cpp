...
static const _DVLBeam_type_support_symbol_names_t _DVLBeam_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cola2_msgs, msg, DVLBeam)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cola2_msgs, msg, DVLBeam)),
  }
};
...
{
  return &::cola2_msgs::msg::rosidl_typesupport_cpp::DVLBeam_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cola2_msgs, msg, DVLBeam)() {
  return get_message_type_support_handle<cola2_msgs::msg::DVLBeam>();
}
