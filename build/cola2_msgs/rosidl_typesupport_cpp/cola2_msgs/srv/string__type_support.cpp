...
static const _String_Request_type_support_symbol_names_t _String_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cola2_msgs, srv, String_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cola2_msgs, srv, String_Request)),
  }
};
...
get_message_type_support_handle<cola2_msgs::srv::String_Request>()
{
  return &::cola2_msgs::srv::rosidl_typesupport_cpp::String_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cola2_msgs, srv, String_Request)() {
  return get_message_type_support_handle<cola2_msgs::srv::String_Request>();
}
...
static const _String_Response_type_support_symbol_names_t _String_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cola2_msgs, srv, String_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cola2_msgs, srv, String_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<cola2_msgs::srv::String_Response>()
{
  return &::cola2_msgs::srv::rosidl_typesupport_cpp::String_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cola2_msgs, srv, String_Response)() {
  return get_message_type_support_handle<cola2_msgs::srv::String_Response>();
}
...
static const _String_type_support_symbol_names_t _String_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cola2_msgs, srv, String)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cola2_msgs, srv, String)),
  }
};
...
get_service_type_support_handle<cola2_msgs::srv::String>()
{
  return &::cola2_msgs::srv::rosidl_typesupport_cpp::String_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, cola2_msgs, srv, String)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<cola2_msgs::srv::String>();
}
