...
static const _Goto_Request_type_support_symbol_names_t _Goto_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cola2_msgs, srv, Goto_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cola2_msgs, srv, Goto_Request)),
  }
};
...
get_message_type_support_handle<cola2_msgs::srv::Goto_Request>()
{
  return &::cola2_msgs::srv::rosidl_typesupport_cpp::Goto_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cola2_msgs, srv, Goto_Request)() {
  return get_message_type_support_handle<cola2_msgs::srv::Goto_Request>();
}
...
static const _Goto_Response_type_support_symbol_names_t _Goto_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cola2_msgs, srv, Goto_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cola2_msgs, srv, Goto_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<cola2_msgs::srv::Goto_Response>()
{
  return &::cola2_msgs::srv::rosidl_typesupport_cpp::Goto_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cola2_msgs, srv, Goto_Response)() {
  return get_message_type_support_handle<cola2_msgs::srv::Goto_Response>();
}
...
static const _Goto_type_support_symbol_names_t _Goto_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cola2_msgs, srv, Goto)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cola2_msgs, srv, Goto)),
  }
};
...
get_service_type_support_handle<cola2_msgs::srv::Goto>()
{
  return &::cola2_msgs::srv::rosidl_typesupport_cpp::Goto_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, cola2_msgs, srv, Goto)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<cola2_msgs::srv::Goto>();
}
