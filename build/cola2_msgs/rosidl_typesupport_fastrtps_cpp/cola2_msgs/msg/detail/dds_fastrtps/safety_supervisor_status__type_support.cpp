...
#include "cola2_msgs/msg/detail/safety_supervisor_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cola2_msgs::msg::SafetySupervisorStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cola2_msgs::msg::SafetySupervisorStatus & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cola2_msgs
max_serialized_size_SafetySupervisorStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs::msg::SafetySupervisorStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cola2_msgs::msg::SafetySupervisorStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cola2_msgs::msg::SafetySupervisorStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SafetySupervisorStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cola2_msgs::msg::SafetySupervisorStatus *>(
...
static size_t _SafetySupervisorStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SafetySupervisorStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SafetySupervisorStatus__callbacks = {
  "cola2_msgs::msg",
...
static rosidl_message_type_support_t _SafetySupervisorStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SafetySupervisorStatus__callbacks,
...
{
  return &cola2_msgs::msg::typesupport_fastrtps_cpp::_SafetySupervisorStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cola2_msgs, msg, SafetySupervisorStatus)() {
  return &cola2_msgs::msg::typesupport_fastrtps_cpp::_SafetySupervisorStatus__handle;
}
