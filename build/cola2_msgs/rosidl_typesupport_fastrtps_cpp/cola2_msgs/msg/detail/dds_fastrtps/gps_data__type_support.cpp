...
#include "cola2_msgs/msg/detail/gps_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cola2_msgs::msg::GPSData & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: raw_gpgga
  cdr << ros_message.raw_gpgga;
  // Member: raw_gphdt
  cdr << ros_message.raw_gphdt;
  // Member: raw_gpgst
  cdr << ros_message.raw_gpgst;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cola2_msgs::msg::GPSData & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs::msg::GPSData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cola2_msgs::msg::GPSData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cola2_msgs::msg::GPSData *>(
    untyped_ros_message);
...
get_message_type_support_handle<cola2_msgs::msg::GPSData>()
{
  return &cola2_msgs::msg::typesupport_fastrtps_cpp::_GPSData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cola2_msgs, msg, GPSData)() {
  return &cola2_msgs::msg::typesupport_fastrtps_cpp::_GPSData__handle;
}
