...
#include "cola2_msgs/msg/detail/mission_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs::msg::MissionState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cola2_msgs::msg::MissionState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cola2_msgs::msg::MissionState *>(
    untyped_ros_message);
...
{
  return &cola2_msgs::msg::typesupport_fastrtps_cpp::_MissionState__handle;
}
