...
#include "cola2_msgs/msg/detail/float32_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cola2_msgs::msg::Float32Stamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cola2_msgs::msg::Float32Stamped & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs::msg::Float32Stamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cola2_msgs::msg::Float32Stamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cola2_msgs::msg::Float32Stamped *>(
    untyped_ros_message);
...
{
  return &cola2_msgs::msg::typesupport_fastrtps_cpp::_Float32Stamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cola2_msgs, msg, Float32Stamped)() {
  return &cola2_msgs::msg::typesupport_fastrtps_cpp::_Float32Stamped__handle;
}
