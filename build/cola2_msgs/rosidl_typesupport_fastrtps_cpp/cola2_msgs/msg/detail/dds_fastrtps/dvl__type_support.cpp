...
#include "cola2_msgs/msg/detail/dvl__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const cola2_msgs::msg::DVLBeam &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  cola2_msgs::msg::DVLBeam &);
size_t get_serialized_size(
  const cola2_msgs::msg::DVLBeam &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const cola2_msgs::msg::DVL & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cola2_msgs::msg::DVL & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: beams
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cola2_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_DVLBeam(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs::msg::DVL;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cola2_msgs::msg::DVL *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cola2_msgs::msg::DVL *>(
    untyped_ros_message);
...
{
  return &cola2_msgs::msg::typesupport_fastrtps_cpp::_DVL__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cola2_msgs, msg, DVL)() {
  return &cola2_msgs::msg::typesupport_fastrtps_cpp::_DVL__handle;
}
