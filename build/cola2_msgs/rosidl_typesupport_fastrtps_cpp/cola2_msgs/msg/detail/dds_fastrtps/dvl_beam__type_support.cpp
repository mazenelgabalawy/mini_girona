...
#include "cola2_msgs/msg/detail/dvl_beam__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cola2_msgs::msg::DVLBeam & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cola2_msgs::msg::DVLBeam & ros_message)
{
  // Member: range
  cdr >> ros_message.range;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs::msg::DVLBeam;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cola2_msgs::msg::DVLBeam *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cola2_msgs::msg::DVLBeam *>(
    untyped_ros_message);
...
{
  return &cola2_msgs::msg::typesupport_fastrtps_cpp::_DVLBeam__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cola2_msgs, msg, DVLBeam)() {
  return &cola2_msgs::msg::typesupport_fastrtps_cpp::_DVLBeam__handle;
}
