...
#include "cola2_msgs/srv/detail/mission__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cola2_msgs::srv::Mission_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cola2_msgs::srv::Mission_Request & ros_message)
{
  // Member: mission
  cdr >> ros_message.mission;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs::srv::Mission_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cola2_msgs::srv::Mission_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cola2_msgs::srv::Mission_Request *>(
    untyped_ros_message);
...
{
  return &cola2_msgs::srv::typesupport_fastrtps_cpp::_Mission_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cola2_msgs, srv, Mission_Request)() {
  return &cola2_msgs::srv::typesupport_fastrtps_cpp::_Mission_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cola2_msgs
cdr_serialize(
  const cola2_msgs::srv::Mission_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cola2_msgs::srv::Mission_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cola2_msgs::srv::Mission_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cola2_msgs::srv::Mission_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cola2_msgs::srv::Mission_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cola2_msgs::srv::typesupport_fastrtps_cpp::_Mission_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cola2_msgs, srv, Mission_Response)() {
  return &cola2_msgs::srv::typesupport_fastrtps_cpp::_Mission_Response__handle;
}
...
{
  return &cola2_msgs::srv::typesupport_fastrtps_cpp::_Mission__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cola2_msgs, srv, Mission)() {
  return &cola2_msgs::srv::typesupport_fastrtps_cpp::_Mission__handle;
}
