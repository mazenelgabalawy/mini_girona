...
#include "cola2_msgs/srv/detail/string__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs::srv::String_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cola2_msgs::srv::String_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cola2_msgs::srv::String_Request *>(
    untyped_ros_message);
...
{
  return &cola2_msgs::srv::typesupport_fastrtps_cpp::_String_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cola2_msgs::srv::String_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cola2_msgs::srv::String_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cola2_msgs::srv::String_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cola2_msgs::srv::typesupport_fastrtps_cpp::_String_Response__handle;
}
...
{
  return &cola2_msgs::srv::typesupport_fastrtps_cpp::_String__handle;
}
