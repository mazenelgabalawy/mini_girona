    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'cola2_msgs.msg.Setpoints')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__setpoints
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__setpoints
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__setpoints
            cls._TYPE_SUPPORT = module.type_support_msg__msg__setpoints
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__setpoints
...
class Setpoints(metaclass=Metaclass_Setpoints):
    ...
    def __init__(self, **kwargs):
        ...
        self.setpoints = array.array('d', kwargs.get('setpoints', []))
    ...
    def setpoints(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'setpoints' array.array() must have the type code of 'd'"
        ...
        self._setpoints = array.array('d', value)
