...
#ifndef COLA2_MSGS__MSG__DETAIL__DVL_BEAM__TRAITS_HPP_
#define COLA2_MSGS__MSG__DETAIL__DVL_BEAM__TRAITS_HPP_
...
inline void to_yaml(
  const cola2_msgs::msg::DVLBeam & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const cola2_msgs::msg::DVLBeam & msg)
{
  return cola2_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<cola2_msgs::msg::DVLBeam>()
{
  return "cola2_msgs::msg::DVLBeam";
}

template<>
inline const char * name<cola2_msgs::msg::DVLBeam>()
{
  return "cola2_msgs/msg/DVLBeam";
}

template<>
struct has_fixed_size<cola2_msgs::msg::DVLBeam>
  : std::integral_constant<bool, has_fixed_size<geometry_msgs::msg::PoseStamped>::value> {};

template<>
struct has_bounded_size<cola2_msgs::msg::DVLBeam>
  : std::integral_constant<bool, has_bounded_size<geometry_msgs::msg::PoseStamped>::value> {};

template<>
struct is_message<cola2_msgs::msg::DVLBeam>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // COLA2_MSGS__MSG__DETAIL__DVL_BEAM__TRAITS_HPP_
