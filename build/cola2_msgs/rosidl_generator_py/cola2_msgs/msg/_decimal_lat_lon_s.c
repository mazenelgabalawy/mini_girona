...
bool cola2_msgs__msg__decimal_lat_lon__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cola2_msgs.msg._decimal_lat_lon.DecimalLatLon", full_classname_dest, 45) == 0);
  }
  cola2_msgs__msg__DecimalLatLon * ros_message = _ros_message;
  {  // latitude
...
{
  /* NOTE(esteve): Call constructor of DecimalLatLon */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cola2_msgs.msg._decimal_lat_lon");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DecimalLatLon");
