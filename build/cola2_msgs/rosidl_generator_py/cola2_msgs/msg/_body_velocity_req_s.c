...
bool cola2_msgs__msg__body_velocity_req__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cola2_msgs.msg._body_velocity_req.BodyVelocityReq", full_classname_dest, 49) == 0);
  }
  cola2_msgs__msg__BodyVelocityReq * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of BodyVelocityReq */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cola2_msgs.msg._body_velocity_req");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BodyVelocityReq");
