...
bool cola2_msgs__msg__key_value_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cola2_msgs.msg._key_value_array.KeyValueArray", full_classname_dest, 45) == 0);
  }
  cola2_msgs__msg__KeyValueArray * ros_message = _ros_message;
  {  // keyvalues
...
{
  /* NOTE(esteve): Call constructor of KeyValueArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cola2_msgs.msg._key_value_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "KeyValueArray");
