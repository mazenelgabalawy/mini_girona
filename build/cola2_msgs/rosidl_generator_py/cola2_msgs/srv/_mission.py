...
class Metaclass_Mission(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from cola2_msgs.srv import _mission
...
class Mission(metaclass=Metaclass_Mission):
    from cola2_msgs.srv._mission import Mission_Request as Request
    from cola2_msgs.srv._mission import Mission_Response as Response
