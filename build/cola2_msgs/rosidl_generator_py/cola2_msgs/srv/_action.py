        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'param' field must be a set or sequence and each value of type 'str'"
        self._param = value
...
class Metaclass_Action(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from cola2_msgs.srv import _action
...
class Action(metaclass=Metaclass_Action):
    from cola2_msgs.srv._action import Action_Request as Request
    from cola2_msgs.srv._action import Action_Response as Response
