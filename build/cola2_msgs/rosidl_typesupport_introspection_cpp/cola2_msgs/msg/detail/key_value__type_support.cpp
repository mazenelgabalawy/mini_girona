...
{
  new (message_memory) cola2_msgs::msg::KeyValue(_init);
}

void KeyValue_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cola2_msgs::msg::KeyValue *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember KeyValue_message_member_array[2] = {
  {
    ...
    offsetof(cola2_msgs::msg::KeyValue, key),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cola2_msgs::msg::KeyValue, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers KeyValue_message_members = {
  ...
  2,  // number of fields
  sizeof(cola2_msgs::msg::KeyValue),
...
{
  return &::cola2_msgs::msg::rosidl_typesupport_introspection_cpp::KeyValue_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cola2_msgs, msg, KeyValue)() {
  return &::cola2_msgs::msg::rosidl_typesupport_introspection_cpp::KeyValue_message_type_support_handle;
}
