...
{
  new (message_memory) cola2_msgs::msg::DVLBeam(_init);
}

void DVLBeam_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cola2_msgs::msg::DVLBeam *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DVLBeam_message_member_array[5] = {
  {
    ...
    offsetof(cola2_msgs::msg::DVLBeam, range),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cola2_msgs::msg::DVLBeam, range_covariance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cola2_msgs::msg::DVLBeam, velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cola2_msgs::msg::DVLBeam, velocity_covariance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cola2_msgs::msg::DVLBeam, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<cola2_msgs::msg::DVLBeam>()
{
  return &::cola2_msgs::msg::rosidl_typesupport_introspection_cpp::DVLBeam_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cola2_msgs, msg, DVLBeam)() {
  return &::cola2_msgs::msg::rosidl_typesupport_introspection_cpp::DVLBeam_message_type_support_handle;
}
