...
cola2_msgs__srv__Section_Request__create()
{
  ...
  cola2_msgs__srv__Section_Request * msg = (cola2_msgs__srv__Section_Request *)allocator.allocate(sizeof(cola2_msgs__srv__Section_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(cola2_msgs__srv__Section_Request));
  bool success = cola2_msgs__srv__Section_Request__init(msg);
  if (!success) {
...
cola2_msgs__srv__Section_Request__destroy(cola2_msgs__srv__Section_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    cola2_msgs__srv__Section_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
cola2_msgs__srv__Section_Request__Sequence__init(cola2_msgs__srv__Section_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cola2_msgs__srv__Section_Request * data = NULL;

  if (size) {
    data = (cola2_msgs__srv__Section_Request *)allocator.zero_allocate(size, sizeof(cola2_msgs__srv__Section_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = cola2_msgs__srv__Section_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        cola2_msgs__srv__Section_Request__fini(&data[i - 1]);
      }
...
cola2_msgs__srv__Section_Request__Sequence__fini(cola2_msgs__srv__Section_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      cola2_msgs__srv__Section_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cola2_msgs__srv__Section_Request__Sequence * array = (cola2_msgs__srv__Section_Request__Sequence *)allocator.allocate(sizeof(cola2_msgs__srv__Section_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = cola2_msgs__srv__Section_Request__Sequence__init(array, size);
  if (!success) {
...
cola2_msgs__srv__Section_Request__Sequence__destroy(cola2_msgs__srv__Section_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    cola2_msgs__srv__Section_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
cola2_msgs__srv__Section_Request__Sequence__are_equal(const cola2_msgs__srv__Section_Request__Sequence * lhs, const cola2_msgs__srv__Section_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!cola2_msgs__srv__Section_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  cola2_msgs__srv__Section_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(cola2_msgs__srv__Section_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    cola2_msgs__srv__Section_Request * data =
      (cola2_msgs__srv__Section_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!cola2_msgs__srv__Section_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          cola2_msgs__srv__Section_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!cola2_msgs__srv__Section_Request__copy(
...
cola2_msgs__srv__Section_Response__init(cola2_msgs__srv__Section_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    cola2_msgs__srv__Section_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cola2_msgs__srv__Section_Response * msg = (cola2_msgs__srv__Section_Response *)allocator.allocate(sizeof(cola2_msgs__srv__Section_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(cola2_msgs__srv__Section_Response));
  bool success = cola2_msgs__srv__Section_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
cola2_msgs__srv__Section_Response__Sequence__init(cola2_msgs__srv__Section_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cola2_msgs__srv__Section_Response * data = NULL;

  if (size) {
    data = (cola2_msgs__srv__Section_Response *)allocator.zero_allocate(size, sizeof(cola2_msgs__srv__Section_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = cola2_msgs__srv__Section_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        cola2_msgs__srv__Section_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
cola2_msgs__srv__Section_Response__Sequence__fini(cola2_msgs__srv__Section_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      cola2_msgs__srv__Section_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cola2_msgs__srv__Section_Response__Sequence * array = (cola2_msgs__srv__Section_Response__Sequence *)allocator.allocate(sizeof(cola2_msgs__srv__Section_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = cola2_msgs__srv__Section_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
cola2_msgs__srv__Section_Response__Sequence__destroy(cola2_msgs__srv__Section_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    cola2_msgs__srv__Section_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
cola2_msgs__srv__Section_Response__Sequence__are_equal(const cola2_msgs__srv__Section_Response__Sequence * lhs, const cola2_msgs__srv__Section_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!cola2_msgs__srv__Section_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  cola2_msgs__srv__Section_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(cola2_msgs__srv__Section_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    cola2_msgs__srv__Section_Response * data =
      (cola2_msgs__srv__Section_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!cola2_msgs__srv__Section_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          cola2_msgs__srv__Section_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!cola2_msgs__srv__Section_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
