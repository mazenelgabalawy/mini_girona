...
#include "cola2_msgs/srv/detail/action__rosidl_typesupport_fastrtps_c.h"
...
using _Action_Request__ros_msg_type = cola2_msgs__srv__Action_Request;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: param
  {
    ...
    if (ros_message->param.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->param);
    }
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->param, size)) {
...
size_t get_serialized_size_cola2_msgs__srv__Action_Request(
  const void * untyped_ros_message,
...
static uint32_t _Action_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cola2_msgs__srv__Action_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cola2_msgs
size_t max_serialized_size_cola2_msgs__srv__Action_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs__srv__Action_Request;
    is_plain =
      (
...
static size_t _Action_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cola2_msgs__srv__Action_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cola2_msgs, srv, Action_Request)() {
...
using _Action_Response__ros_msg_type = cola2_msgs__srv__Action_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cola2_msgs
size_t get_serialized_size_cola2_msgs__srv__Action_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Action_Response__ros_msg_type * ros_message = static_cast<const _Action_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_cola2_msgs__srv__Action_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cola2_msgs
size_t max_serialized_size_cola2_msgs__srv__Action_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cola2_msgs__srv__Action_Response;
    is_plain =
      (
...
static size_t _Action_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cola2_msgs__srv__Action_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cola2_msgs, srv, Action_Response)() {
...
// already included above
// #include "cola2_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "cola2_msgs/srv/action.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cola2_msgs, srv, Action)() {
