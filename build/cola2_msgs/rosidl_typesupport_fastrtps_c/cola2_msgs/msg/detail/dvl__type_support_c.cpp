...
#include "cola2_msgs/msg/detail/dvl__rosidl_typesupport_fastrtps_c.h"
...
#include "cola2_msgs/msg/detail/dvl_beam__functions.h"  // beams
#include "geometry_msgs/msg/detail/vector3__functions.h"  // velocity
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_cola2_msgs__msg__DVLBeam(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_cola2_msgs__msg__DVLBeam(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cola2_msgs, msg, DVLBeam)();
...
using _DVL__ros_msg_type = cola2_msgs__msg__DVL;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: beams
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, cola2_msgs, msg, DVLBeam
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: beams
  {
    ...
    if (ros_message->beams.data) {
      cola2_msgs__msg__DVLBeam__Sequence__fini(&ros_message->beams);
    }
    if (!cola2_msgs__msg__DVLBeam__Sequence__init(&ros_message->beams, size)) {
...
size_t get_serialized_size_cola2_msgs__msg__DVL(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DVL__ros_msg_type * ros_message = static_cast<const _DVL__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name beams
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_cola2_msgs__msg__DVLBeam(
...
static uint32_t _DVL__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cola2_msgs__msg__DVL(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cola2_msgs
size_t max_serialized_size_cola2_msgs__msg__DVL(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: beams
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cola2_msgs__msg__DVLBeam(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs__msg__DVL;
    is_plain =
      (
...
static size_t _DVL__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cola2_msgs__msg__DVL(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cola2_msgs, msg, DVL)() {
