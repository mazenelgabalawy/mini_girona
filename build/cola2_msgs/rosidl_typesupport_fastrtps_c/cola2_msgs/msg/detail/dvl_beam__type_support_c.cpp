...
#include "cola2_msgs/msg/detail/dvl_beam__rosidl_typesupport_fastrtps_c.h"
...
using _DVLBeam__ros_msg_type = cola2_msgs__msg__DVLBeam;
...
static uint32_t _DVLBeam__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cola2_msgs__msg__DVLBeam(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs__msg__DVLBeam;
    is_plain =
      (
...
static size_t _DVLBeam__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cola2_msgs__msg__DVLBeam(
