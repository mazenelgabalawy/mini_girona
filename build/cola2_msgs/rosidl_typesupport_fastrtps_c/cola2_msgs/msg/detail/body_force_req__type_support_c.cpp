...
#include "cola2_msgs/msg/detail/body_force_req__rosidl_typesupport_fastrtps_c.h"
...
using _BodyForceReq__ros_msg_type = cola2_msgs__msg__BodyForceReq;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BodyForceReq__ros_msg_type * ros_message = static_cast<const _BodyForceReq__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _BodyForceReq__ros_msg_type * ros_message = static_cast<_BodyForceReq__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_cola2_msgs__msg__BodyForceReq(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BodyForceReq__ros_msg_type * ros_message = static_cast<const _BodyForceReq__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BodyForceReq__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cola2_msgs__msg__BodyForceReq(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cola2_msgs
size_t max_serialized_size_cola2_msgs__msg__BodyForceReq(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs__msg__BodyForceReq;
    is_plain =
      (
...
static size_t _BodyForceReq__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cola2_msgs__msg__BodyForceReq(
...
static message_type_support_callbacks_t __callbacks_BodyForceReq = {
  "cola2_msgs::msg",
  "BodyForceReq",
...
static rosidl_message_type_support_t _BodyForceReq__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BodyForceReq,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cola2_msgs, msg, BodyForceReq)() {
  return &_BodyForceReq__type_support;
}
