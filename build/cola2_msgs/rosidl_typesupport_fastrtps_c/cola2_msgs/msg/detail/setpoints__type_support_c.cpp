...
#include "cola2_msgs/msg/detail/setpoints__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // setpoints
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // setpoints
...
using _Setpoints__ros_msg_type = cola2_msgs__msg__Setpoints;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: setpoints
  {
    ...
    if (ros_message->setpoints.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->setpoints);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->setpoints, size)) {
...
size_t get_serialized_size_cola2_msgs__msg__Setpoints(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Setpoints__ros_msg_type * ros_message = static_cast<const _Setpoints__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Setpoints__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cola2_msgs__msg__Setpoints(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cola2_msgs
size_t max_serialized_size_cola2_msgs__msg__Setpoints(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs__msg__Setpoints;
    is_plain =
      (
...
static size_t _Setpoints__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cola2_msgs__msg__Setpoints(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cola2_msgs, msg, Setpoints)() {
