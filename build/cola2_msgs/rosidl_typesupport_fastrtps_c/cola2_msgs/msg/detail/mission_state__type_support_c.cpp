...
#include "cola2_msgs/msg/detail/mission_state__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/detail/time__functions.h"  // last_active
...
using _MissionState__ros_msg_type = cola2_msgs__msg__MissionState;
...
size_t get_serialized_size_cola2_msgs__msg__MissionState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MissionState__ros_msg_type * ros_message = static_cast<const _MissionState__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_builtin_interfaces__msg__Time(
    &(ros_message->last_active), current_alignment);
...
static uint32_t _MissionState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cola2_msgs__msg__MissionState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cola2_msgs
size_t max_serialized_size_cola2_msgs__msg__MissionState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs__msg__MissionState;
    is_plain =
      (
      offsetof(DataType, last_active) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _MissionState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cola2_msgs__msg__MissionState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cola2_msgs, msg, MissionState)() {
