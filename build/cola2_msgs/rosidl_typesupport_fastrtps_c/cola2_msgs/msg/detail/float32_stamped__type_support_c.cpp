...
#include "cola2_msgs/msg/detail/float32_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _Float32Stamped__ros_msg_type = cola2_msgs__msg__Float32Stamped;
...
size_t get_serialized_size_cola2_msgs__msg__Float32Stamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Float32Stamped__ros_msg_type * ros_message = static_cast<const _Float32Stamped__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Float32Stamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cola2_msgs__msg__Float32Stamped(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cola2_msgs
size_t max_serialized_size_cola2_msgs__msg__Float32Stamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs__msg__Float32Stamped;
    is_plain =
      (
...
static size_t _Float32Stamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cola2_msgs__msg__Float32Stamped(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cola2_msgs, msg, Float32Stamped)() {
