...
#include "cola2_msgs/msg/detail/ned__rosidl_typesupport_fastrtps_c.h"
...
using _NED__ros_msg_type = cola2_msgs__msg__NED;
...
static uint32_t _NED__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cola2_msgs__msg__NED(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs__msg__NED;
    is_plain =
      (
...
static size_t _NED__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cola2_msgs__msg__NED(
