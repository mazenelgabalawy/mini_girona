...
#include "cola2_msgs/msg/detail/world_waypoint_req__rosidl_typesupport_fastrtps_c.h"
...
#include "cola2_msgs/msg/detail/ned__functions.h"  // position
#include "cola2_msgs/msg/detail/rpy__functions.h"  // orientation, orientation_tolerance
...
using _WorldWaypointReq__ros_msg_type = cola2_msgs__msg__WorldWaypointReq;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _WorldWaypointReq__ros_msg_type * ros_message = static_cast<const _WorldWaypointReq__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _WorldWaypointReq__ros_msg_type * ros_message = static_cast<_WorldWaypointReq__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_cola2_msgs__msg__WorldWaypointReq(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WorldWaypointReq__ros_msg_type * ros_message = static_cast<const _WorldWaypointReq__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _WorldWaypointReq__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cola2_msgs__msg__WorldWaypointReq(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cola2_msgs
size_t max_serialized_size_cola2_msgs__msg__WorldWaypointReq(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cola2_msgs__msg__WorldWaypointReq;
    is_plain =
      (
...
static size_t _WorldWaypointReq__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cola2_msgs__msg__WorldWaypointReq(
...
static message_type_support_callbacks_t __callbacks_WorldWaypointReq = {
  "cola2_msgs::msg",
  "WorldWaypointReq",
...
static rosidl_message_type_support_t _WorldWaypointReq__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_WorldWaypointReq,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cola2_msgs, msg, WorldWaypointReq)() {
  return &_WorldWaypointReq__type_support;
}
