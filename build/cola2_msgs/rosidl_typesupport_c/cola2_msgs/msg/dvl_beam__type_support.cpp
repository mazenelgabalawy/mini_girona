...
static const _DVLBeam_type_support_symbol_names_t _DVLBeam_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cola2_msgs, msg, DVLBeam)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cola2_msgs, msg, DVLBeam)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cola2_msgs, msg, DVLBeam)() {
  return &::cola2_msgs::msg::rosidl_typesupport_c::DVLBeam_message_type_support_handle;
}
